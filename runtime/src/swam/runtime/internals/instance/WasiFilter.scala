...
object WasiFilter {
  ...
  def readWasiFile(): Set[String] = {
    ...
    val undefined_check =
      scala.reflect.io.File("runtime/src/swam/runtime/internals/instance/undefined-symbols.txt").exists
    var define: Set[String] = Set()
    if (defined_check && undefined_check) {
      val defined =
        scala.io.Source.fromFile("runtime/src/swam/runtime/internals/instance/defined-symbols.txt", "UTF-8").mkString
      val undefined =
        scala.io.Source.fromFile("runtime/src/swam/runtime/internals/instance/undefined-symbols.txt", "UTF-8").mkString
